    ...
    public class WordSaveService : FileSaveService
    {
        ...
        protected override void save(MemoryStream chartImage, List<Car> carList, string figureTitle, string fileName)
        {
            try
            {
                ...
                paragraph.Range.Text = "Cars List" + Environment.NewLine;
                ...
                table.Columns[3].PreferredWidth = 30;
                table.Columns[4].PreferredWidth = 30;
                table.Columns[5].PreferredWidth = 30;
                table.Columns[6].PreferredWidth = 30;
                table.Columns[7].PreferredWidth = 30;
                table.Columns[8].PreferredWidth = 30;
                table.Columns[9].PreferredWidth = 30;
                table.Columns[10].PreferredWidth = 30;
                table.Columns[11].PreferredWidth = 30;
                for (int j = 1; j <= 5; j++)
                {
                ...
                table.Cell(1, 6).Range.Text = "Year";
                table.Cell(1, 7).Range.Text = "EngineNo";
                table.Cell(1, 8).Range.Text = "PlateNo";
                table.Cell(1, 9).Range.Text = "Defect";
                table.Cell(1, 10).Range.Text = "RepairCost";
                table.Cell(1, 11).Range.Text = "Repaired";
                ...
                for (int i = 2; i <= rowsNumber; i++)
                {
                    ...
                    table.Cell(i, 6).Range.Text = carList[i - 2].Year.ToString();
                    table.Cell(i, 7).Range.Text = carList[i - 2].EngineNo.ToString();
                    table.Cell(i, 8).Range.Text = carList[i - 2].PlateNo.ToString();
                    table.Cell(i, 9).Range.Text = carList[i - 2].Defect.ToString();
                    table.Cell(i, 10).Range.Text = carList[i - 2].RepairCost.ToString();
                    table.Cell(i, 11).Range.Text = carList[i - 2].Repaired.ToString();
                }
